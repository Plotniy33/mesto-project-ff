...
const cardElement = cardTemlate.querySelector('.card').cloneNode(true);
  cardImg = cardElement.querySelector('.card__image').setAttribute('src', el.link);
  cardImg = cardElement.querySelector('.card__image').setAttribute('alt', el.name);
  cardTitle = cardElement.querySelector('.card__title').textContent = el.name;
  btnDel = cardElement.querySelector('.card__delete-button');
